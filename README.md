...
This repository contains the research code of our recently [accpeted paper](https://shayansss.github.io/files/2022_06_preprint.pdf){:target="_blank"} entitled "**Multi-fidelity surrogate modeling through hybrid machine learning for biomechanical and finite element analysis of soft tissues**".
